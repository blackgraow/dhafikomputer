...
-- Default Brands
INSERT INTO `brands` (`id`, `code`, `name`, `logo_url`) VALUES
(1, 'BRD-ASUS', 'ASUS', 'https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=300'),
(2, 'BRD-LNV', 'Lenovo', 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=300'),
(3, 'BRD-ACR', 'Acer', 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=300'),
(4, 'BRD-HP', 'HP', 'https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?w=300'),
(5, 'BRD-MSI', 'MSI', 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=300'),
(6, 'BRD-DELL', 'Dell', 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=300'),
(7, 'BRD-AAPL', 'Apple', 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=300')
ON DUPLICATE KEY UPDATE `id`=`id`;
...
-- Default Master Dealers (ALL BRAND - Sumber Laptop Baru)
...
-- Default Dealers (Toko Lain - Sumber Laptop Second)
...
INSERT INTO `laptops` (
  ...
  `processor`, `ram`, `storage`, `gpu`, `screen_size`, `operating_system`, `color`, `release_year`, `warranty`, `serial_number`, `condition_notes`,
...
(
  ...
  'Intel Core i3-1215U', '8GB DDR4', '512GB NVMe SSD', 'Intel UHD Graphics', '14.0 FHD', 'Windows 11 Home', 'Quiet Blue', '2023', '2 Tahun Garansi Resmi', 'SN-ASUS-1001', NULL,
...
(
  ...
  'AMD Ryzen 5 6600H', '16GB DDR5', '512GB NVMe SSD', 'NVIDIA RTX 3050 4GB', '15.6 FHD 120Hz', 'Windows 11 Home', 'Onyx Grey', '2023', '2 Tahun ADP Garansi Resmi', 'SN-LNV-2002', NULL,
...
(
  ...
  'Apple M1 Chip (8-Core CPU)', '8GB Unified RAM', '256GB SSD', '7-Core GPU', '13.3 Retina Display', 'macOS Sonoma', 'Space Grey', '2020', 'Garansi Toko 1 Bulan', 'SN-AAPL-3003', 'Kondisi 95% mulus, battery health 88%, kelengkapan magsafe charger original',
...
(
  ...
  'Intel Core i5-8365U', '16GB DDR4', '256GB SSD', 'Intel UHD 620', '14.0 FHD IPS', 'Windows 10 Pro', 'Black', '2019', 'Garansi Toko 2 Minggu', 'SN-DELL-4004', 'Body 90% lecet pemakaian wajar, layar jernih tanpa deadpixel, keyboard empuk',
